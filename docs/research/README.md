...
- The canonical Sokpop reference (sokpop.itch.io) for the minimalist-procedural rendering style this engine aims to support.
...
- **IAP bridge adapter pattern** (interface shape mirroring a defensive `SaveStorage`; entitlement state model; platform adapter lifecycle) — feeds Pillar 3 IAP
