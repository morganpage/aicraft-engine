# Prompt: "Doodle Knight" — a procedural endless climber with music-driven difficulty on `aicraft-engine@0.17.4`
...
> This brief targets the published `0.17.4` API exactly. It was originally
