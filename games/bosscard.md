# Bosscard — A Three-Phase Bullet-Hell Boss Fight on `aicraft-engine@0.17.4`
...
- **`aicraft-engine@0.17.4`** is your only runtime dependency. Import from the **root barrel only**:
  ```ts
  import {
    // game-loop + state FSM
