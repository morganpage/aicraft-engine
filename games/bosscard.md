# Bosscard — A Three-Phase Bullet-Hell Boss Fight on `aicraft-engine@0.15.0`
...
- **`aicraft-engine@0.15.0`** is your only runtime dependency. Import from the **root barrel only**:
  ```ts
  import {
    // game-loop + state FSM
