...
Status: **Phases 1, 2 and 5 (partial) landed** — `f2d9b31` (characterization) and `4f320f6` (module + tests); Phases 3, 4, 6, 7 outstanding. Targets release `0.18.0` (current tree is `0.17.5`).
