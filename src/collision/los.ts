import type { TileSolidityQuery, TileType } from './types';

/** Maximum unique cells a public LOS query may visit. */
...
/**
 * Internal test seam for independently exercising predicted/runtime caps.
 * This symbol is intentionally not re-exported from the collision barrel.
 */
...
/**
 * Check visibility with a defensive, capped supercover tile traversal.
 *
 * Only `solid` blocks. Start/end cells and both orthogonal neighbors at an
 * exact corner are visited. Invalid or pathological input fails closed.
 */
