...
export function realizeBlueprint(
  ...
  const physics = derivePhysicsConstraints(
    (config ?? {}).platformerConfig ?? { gravity: 980, maxFallSpeed: 600, fastMaxFallSpeed: 900, fastMaxAccel: 327, moveSpeed: 200, runAccel: 2220, overspeedReduce: 890, airAccelMultiplier: 0.65, jump: { apexHeight: 48, timeToApex: 0.28, jumpCutoffFactor: 0.4, fallMultiplier: 2.5, coyoteTime: 0.08, jumpBufferTime: 0.1, landingSquashMin: 0.7, landingSquashStiffness: 180, landingSquashDamping: 12, anticipationDuration: 0.05, anticipationSquash: 0.85, launchStretch: 1.15, airborneBlendRampUp: 4, airborneBlendRampDown: 4 } as any, wallSlideEnabled: true, wallSlideStartMax: 75, wallSlideTime: 1.2, wallJumpVx: 220, wallJumpVy: -380, wallJumpLockTime: 0.12, dashEnabled: true, dashSpeed: 420, dashDuration: 0.12, dashStartupTime: 0.05, dashCooldown: 0.3, endDashSpeedFactor: 0.67, endDashUpMult: 0.75, maxDashes: 1, doubleJumpEnabled: false, maxDoubleJumps: 0, climbEnabled: false, climbSpeed: 120, superJumpVx: 578, superWallJumpVx: 378, superWallJumpVy: -523, dodgeSlideSpeedMult: 1.2, duckSuperJumpXMult: 1.25, duckSuperJumpYMult: 0.5, duckFriction: 1110, superJumpGrace: 0.1, wallGrabEnabled: false, wallGrabMaxStamina: 110, staminaUpCostPerSec: 45.45, staminaStillCostPerSec: 10, staminaClimbJumpCost: 27.5, wallClimbUpSpeed: 100, wallClimbDownSpeed: 178, climbHopVy: 267, climbHopVx: 222, climbHopForceTime: 0.2, climbJumpBoostTime: 0.2, climbUpCheckDist: 2, mantleEnabled: true, mantleHopVx: 100, mantleHopVy: 267, mantleApexClearance: 6, mantleLandingInset: 8, mantleAssistTime: 0.35, climbJumpRegrabLockTime: 0.12, upwardCornerCorrection: 8, dashCornerCorrection: 8, wallSpeedRetentionTime: 0.06, springBounceVy: -460, springSuperBounceVy: -605, springVarJumpTime: 0.2, springAutoJumpTime: 0.1 },
    tileSize,
  );
