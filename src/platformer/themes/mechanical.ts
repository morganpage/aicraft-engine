...
export const MECHANICAL_LEVEL_THEME: Readonly<LevelRenderTheme> = {
  ...
  terrain: {
    tiles: {
      1: { id: 'mechanical-plate', palette: { fill: '#52616b', top: '#9dabb0', side: '#36434d', outline: '#172027', detail: '#26333b', accent: '#d7a84b' }, surfaceDetail: 'rivets' },
      2: { id: 'mechanical-rail', palette: { fill: '#625d54', top: '#c4b276', side: '#413d38', outline: '#172027', detail: '#302d29', accent: '#e1b94f' }, surfaceDetail: 'rivets' },
    },
    solid: { id: 'mechanical-solid', palette: { fill: '#52616b', top: '#9dabb0', side: '#36434d', outline: '#172027', detail: '#26333b', accent: '#d7a84b' }, surfaceDetail: 'rivets' },
    passthrough: { id: 'mechanical-rail', palette: { fill: '#625d54', top: '#c4b276', side: '#413d38', outline: '#172027', accent: '#e1b94f' } },
    moving: { id: 'mechanical-moving', palette: { fill: '#657985', top: '#b6c4c8', side: '#40515b', outline: '#10181d', detail: '#26333b', accent: '#f0b83f' }, surfaceDetail: 'rivets', detailDensity: 0.8 },
